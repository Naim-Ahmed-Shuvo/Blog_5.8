...
<head>
  ...
  <link href="{{url('/')}}/frontend/css/fancybox/jquery.fancybox.css" rel="stylesheet">
  <link href="{{url('/')}}/frontend/css/jcarousel.css" rel="stylesheet" />
  <link href="{{url('/')}}/frontend/css/flexslider.css" rel="stylesheet" />
  <link href="{{url('/')}}/frontend/css/style.css" rel="stylesheet" />
  <!-- Theme skin -->
  <link href="{{url('/')}}/frontend/skins/default.css" rel="stylesheet" />
  <!-- Fav and touch icons -->
  <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{url('/')}}/frontend/ico/apple-touch-icon-144-precomposed.png" />
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{url('/')}}/frontend/ico/apple-touch-icon-114-precomposed.png" />
  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{url('/')}}/frontend/ico/apple-touch-icon-72-precomposed.png" />
  <link rel="apple-touch-icon-precomposed" href="{{url('/')}}/frontend/ico/apple-touch-icon-57-precomposed.png" />
  <link rel="shortcut icon" href="{{url('/')}}/frontend/ico/favicon.png" />
...
<body>
    ...
    <header>
      <div class="container ">
        ...
        <div class="row">
          <div class="span4">
            <div class="logo">
            <a href="index.html"><img src="{{url('/')}}/frontend/img/logo.png" alt="" class="logo" /></a>
  ...
  <script src="{{url('/')}}/frontend/js/jcarousel/jquery.jcarousel.min.js"></script>
  ...
  <script src="{{url('/')}}/frontend/js/portfolio/jquery.quicksand.js"></script>
  <script src="{{url('/')}}/frontend/js/portfolio/setting.js"></script>
  <script src="{{url('/')}}/frontend/js/jquery.flexslider.js"></script>
  <script src="{{url('/')}}/frontend/js/jquery.nivo.slider.js"></script>
  <script src="{{url('/')}}/frontend/js/modernizr.custom.js"></script>
  <script src="{{url('/')}}/frontend/js/jquery.ba-cond.min.js"></script>
  <script src="{{url('/')}}/frontend/js/jquery.slitslider.js"></script>
